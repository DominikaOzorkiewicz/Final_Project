    ...
    return (
        <section className='contact'>
            ...
            <Form className='contact__form' onSubmit={sendEmailToShelter}>
                ...
                <FormGroup>
                    <Label>Name</Label>
                    <Input type='text' name='name' placeholder='Type your name' require="true"/>
                </FormGroup>

                <FormGroup>
                    <Label>Email</Label>
                    <Input type='email' name='email'  placeholder='Type your email' require="true"/>
                </FormGroup>

                <FormGroup>
                    <Label for="exampleText">Your message</Label>
                    <Input type="textarea" name="email-text" id="email-text" require="true"/>
                </FormGroup>

                <FormGroup>
                    <Label for="exampleSelect">Choose shelter</Label>
                    <Input type="select" name="select" id="exampleSelect" onChange={event => handleSetEmail(event)} require="true">
                        { sheltersList.map(shelter => <option value={shelter.email} key={shelter.id}>{shelter.name}</option>) }
                    </Input>
                </FormGroup>
