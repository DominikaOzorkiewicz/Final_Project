            ...
            <Container className='home__container container' >
                    ...
                    {logged === true ? (
                        <>
                            ...
                            <div className='home__buttons'>
                                <Link className='home__link' to='/dogList'>
                                    <img
                                        ...
                                        src="https://img.icons8.com/ios/50/000000/hachiko.png"
                                        alt='Dog icon'
                                    />
                                    <p>Dogs</p>
                                </Link>
                            ...
                            <Button tag={Link} to='/userprofile'>
                                My account
                            </Button>
                        </>
                        ) : (
                        <>
                            <p className='home__text' >
                                Please login to search for your new animal friend.
                            </p>
                            <Button className='home__button' size="lg" tag={Link} to='/login'>
                                Log in
                            </Button>
                            <p className='home__text-register'>
                                No account? Register
